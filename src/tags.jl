...
function _tag(sig::S, data::Union{LUT8,LUT16,LUTAToB,LUTBToA}, ver) where {S<:PreviewSignature}
...
function _tag(::S, data::Union{TaggedText,MultiLocalizedUnicode}, ver) where {S<:sigtype"cprt"}
...
function _tag(::S, data::Union{TextDescription,MultiLocalizedUnicode}, ver) where {S<:sigtype"desc"}
